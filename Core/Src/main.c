...
/* Private typedef -----------------------------------------------------------*/
/* USER CODE BEGIN PTD */
//  Private Type Definitions	사용자 정의 struct나 enum 타입을 선언하는 곳
/* USER CODE END PTD */

/* Private define ------------------------------------------------------------*/
/* USER CODE BEGIN PD */
// Private Defines #define으로 매직넘버 정의하는 곳
/* USER CODE END PD */

/* Private macro -------------------------------------------------------------*/
/* USER CODE BEGIN PM */
//	Private Macros	#define 매크로를 정의하는 곳
/* USER CODE END PM */
...
/* USER CODE BEGIN PV */
// Private Variables	전역 변수나 정적(static) 변수를 선언하는 곳
/* USER CODE END PV */
...
/* USER CODE BEGIN PFP */
// Private Function Prototypes	사용자 함수의 원형(Prototype)을 선언하는 곳
/* USER CODE END PFP */

/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
//	Number	코드 실행 순서에 따른 위치 (변수 초기화, 메인 루프 등)
/* USER CODE END 0 */
